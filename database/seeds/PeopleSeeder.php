...
class PeopleSeeder extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 2, 'nume' => 'Owens', 'prenume'=>'Delia','data_nasterii'=>'1949-04-04','judetID'=> 13],
            ['id' => 3, 'nume' => 'Kiyosaki', 'prenume'=>'Kiyosaki','data_nasterii'=>'1947-04-08','judetID'=> 1],
            ['id' => 4, 'nume' => 'Boyne', 'prenume'=>'John','data_nasterii'=>'1971-04-30','judetID'=> 17],
            ['id' => 5, 'nume' => 'Voss', 'prenume'=>'Chris','data_nasterii'=>'1988-03-31','judetID'=> 13],
            ['id' => 6, 'nume' => 'Zusak', 'prenume'=>'Markus','data_nasterii'=>'1975-06-23','judetID'=> 14],
            ['id' => 7, 'nume' => 'Michaelides', 'prenume'=>'Alex','data_nasterii'=>'1977-09-04','judetID'=> 1],
            ['id' => 8, 'nume' => 'Goleman', 'prenume'=>'Daniel','data_nasterii'=>'1946-03-07','judetID'=> 3],
            ['id' => 9, 'nume' => 'Obama', 'prenume'=>'Michelle','data_nasterii'=>'1964-01-17','judetID'=> 16],
            ['id' => 10, 'nume' => 'Chapman', 'prenume'=>'Gary','data_nasterii'=>'1938-01-10','judetID'=> 14],
            ['id' => 11, 'nume' => 'Brown', 'prenume'=>'Brene','data_nasterii'=>'1965-11-18','judetID'=> 15],
            ['id' => 12, 'nume' => 'Lugand', 'prenume'=>'Martin','data_nasterii'=>'1979-07-23','judetID'=> 41],
            ['id' => 13, 'nume' => 'Kishimi', 'prenume'=>'Ichiro','data_nasterii'=>'1956-07-23','judetID'=> 31],
            ['id' => 14, 'nume' => 'Carnegie', 'prenume'=>'Dale','data_nasterii'=>'1888-11-24','judetID'=> 4],
            ['id' => 15, 'nume' => 'Maxwell', 'prenume'=>'John','data_nasterii'=>'1947-02-20','judetID'=> 13],
            ['id' => 16, 'nume' => 'Lippincot', 'prenume'=>'Rachael','data_nasterii'=>'1980-07-23','judetID'=> 1],
            ['id' => 17, 'nume' => 'Moyes', 'prenume'=>'Jojo','data_nasterii'=>'1969-08-04','judetID'=> 13],
            ['id' => 18, 'nume' => 'Alcott', 'prenume'=>'Louisa','data_nasterii'=>'1832-11-29','judetID'=> 10],
            ['id' => 19, 'nume' => 'Creanga', 'prenume'=>'Ion','data_nasterii'=>'1837-03-01','judetID'=> 20],
            ['id' => 20, 'nume' => 'Setepys', 'prenume'=>'Ruta','data_nasterii'=>'1967-11-19','judetID'=> 30],
            ['id' => 21, 'nume' => 'Tolle', 'prenume'=>'Eckhart','data_nasterii'=>'1948-02-16','judetID'=> 3],
            ['id' => 22, 'nume' => 'Frankl', 'prenume'=>'Viktor','data_nasterii'=>'1905-03-26','judetID'=> 1],
            ['id' => 23, 'nume' => 'Black', 'prenume'=>'Holly','data_nasterii'=>'1971-11-10','judetID'=> 8],
            ['id' => 24, 'nume' => 'Atwood', 'prenume'=>'Margarete','data_nasterii'=>'1939-11-18','judetID'=> 4],
            ...
            ['id' => 27, 'nume' => 'Huxley', 'prenume'=>'Aldous','data_nasterii'=>'1894-07-26','judetID'=> 7],
            ['id' => 28, 'nume' => 'Long', 'prenume'=>'Ruperto','data_nasterii'=>'1952-12-23','judetID'=> 17],
            ...
            ['id' => 35, 'nume' => 'Ziglar', 'prenume'=>'Zig','data_nasterii'=>'1926-11-06','judetID'=> 7],
            ...
            ['id' => 39, 'nume' => 'Forman', 'prenume'=>'Gayle','data_nasterii'=>'1970-06-05','judetID'=> 8],
            ['id' => 40, 'nume' => 'Hoover', 'prenume'=>'Colleen','data_nasterii'=>'1979-12-11','judetID'=> 1],
            ['id' => 41, 'nume' => 'Lincu', 'prenume'=>'Cristina','data_nasterii'=>'1979-08-22','judetID'=> 27],
            ['id' => 42, 'nume' => 'Partenie', 'prenume'=>'Catalin','data_nasterii'=>'1971-04-15','judetID'=> 2],
            ['id' => 43, 'nume' => 'Stancu', 'prenume'=>'Zaharia','data_nasterii'=>'1902-10-07','judetID'=> 8],
            ['id' => 44, 'nume' => 'Rusti', 'prenume'=>'Doina','data_nasterii'=>'1957-02-15','judetID'=> 27],
            ['id' => 45, 'nume' => 'Liiceanu', 'prenume'=>'Aurora','data_nasterii'=>'1941-08-01','judetID'=> 9],
            ['id' => 46, 'nume' => 'Culianu', 'prenume'=>'Ioan Petru','data_nasterii'=>'1950-01-05','judetID'=> 2],
            ['id' => 47, 'nume' => 'Serghi', 'prenume'=>'Cella','data_nasterii'=>'1907-11-04','judetID'=> 32],
            ['id' => 48, 'nume' => 'Lungu', 'prenume'=>'Simona','data_nasterii'=>'1973-11-11','judetID'=> 22],
            ['id' => 49, 'nume' => 'Tudose', 'prenume'=>'Maria Cristiana','data_nasterii'=>'1989-03-07','judetID'=> 27],
            ['id' => 50, 'nume' => 'Russo', 'prenume'=>'Andreea','data_nasterii'=>'1990-07-22','judetID'=> 24],
            ['id' => 51, 'nume' => 'Binder', 'prenume'=>'Irina','data_nasterii'=>'1982-05-12','judetID'=> 26],
            ['id' => 52, 'nume' => 'Lazar', 'prenume'=>'George','data_nasterii'=>'1963-02-03','judetID'=> 26],
            ...
            ['id' => 56, 'nume' => 'Adamek', 'prenume'=>'Diana','data_nasterii'=>'1976-10-12','judetID'=> 25],
            ['id' => 57, 'nume' => 'Crudu', 'prenume'=>'Dumitru','data_nasterii'=>'1968-11-10','judetID'=> 2],
            ['id' => 58, 'nume' => 'Giurgiu', 'prenume'=>'Cati','data_nasterii'=>'1965-10-09','judetID'=> 27],
            ...
            ['id' => 62, 'nume' => 'Ardelean', 'prenume'=>'Flavius','data_nasterii'=>'1985-05-05','judetID'=> 23],
            ['id' => 63, 'nume' => 'Duda', 'prenume'=>'Ioana','data_nasterii'=>'1973-09-12','judetID'=> 24],
            ['id' => 64, 'nume' => 'Podoreanu', 'prenume'=>'Cristina','data_nasterii'=>'1967-08-08','judetID'=> 8],
            ...
            ['id' => 68, 'nume' => 'Rebreanu', 'prenume'=>'Liviu','data_nasterii'=>'1885-11-27','judetID'=> 27],
            ...
            ['id' => 73, 'nume' => 'Anghel', 'prenume'=>'Laura','data_nasterii'=>'1987-10-12','judetID'=> 40],
            ...
            ['id' => 82, 'nume' => 'Pop', 'prenume'=>'Marian','data_nasterii'=>'2008-06-06','judetID'=> 40],
            ...
            ['id' => 92, 'nume' => 'Admin', 'prenume'=>'Admin','data_nasterii'=>'1990-10-10','judetID'=> 2]
        ];
